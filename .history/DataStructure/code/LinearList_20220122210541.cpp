...
template<typename T>
T CircularLinkedList<T>::GetData(int i){
    if(i>size-1 || i < 0){
        cout<<"越界了"<<endl;
    }
    else{
...
DoubleLinkedList<T>::DoubleLinkedList(){
    DNode<T> * p = (DNode<T>*)malloc(15);
    p = head;
    size = 0;
}
template <typename T>
bool DoubleLinkedList<T>::Insert(T x,int n){
     if(n>size || n < 0){
        cout<<"越界了"<<endl;
    }
    DNode<T> * p = (DNode<T>*)malloc(15);
...
template<typename T>
bool DoubleLinkedList<T>::drop(int i){
    if(i>size-1 || i < 0){
        cout<<"越界了"<<endl;
    }
     else{
...
template<typename T>
T DoubleLinkedList<T>::GetData(int i){
      if(i>size-1 || i < 0){
        cout<<"越界了"<<endl;
    }
    else{
